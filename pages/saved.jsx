      ...
      <main className="grid grid-cols-11 md:grid-cols-9 max-w-7xl mx-auto">
        ...
        <div className="col-span-9 w-full border-l flex items-center h-screen md:col-span-7 ">
          {!loggedIn ?
            ...
            <Link href='/login?redirect=/saved'><p className="px-4 py-2 mt-2 rounded-full bg-twitter/70 text-gray-100">Log in</p></Link>
          </div>

            :
            <div className="text-lg p-10 shadow-xl mx-auto text-center rounded-xl">
              <BookmarkSlashIcon className="text-twitter/70 text-2xl h-20 w-20 text-center mx-auto my-2"/>
              <p>you don't have Saved yet , <span className=" font-sans font-bold">{user}</span></p>
...
export default dynamic(() => Promise.resolve(Saved), { ssr: false });
